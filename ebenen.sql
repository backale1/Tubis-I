...
CREATE TABLE IF NOT EXISTS `bestellkopf` (
  `_id` int(9) NOT NULL AUTO_INCREMENT,
  `kundennr` int(4) unsigned zerofill DEFAULT NULL,
  `tempkundennr` int(4) unsigned zerofill DEFAULT NULL,
...
INSERT INTO `bestellpositionen` (`_id`, `bpos`, `_id`, `menge`) VALUES
(2, 1, 10101001, 5),
(1, 2, 10101001, 1);
...
CREATE TABLE IF NOT EXISTS `stammkunden` (
  `_id` int(4) unsigned zerofill NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tempkunden` (
  `_id` int(4) unsigned zerofill NOT NULL AUTO_INCREMENT,
